...
- Strict MIME/signature agreement, streaming byte caps, bounded auth JSON, image pixel limits, PDF page limits, encrypted-PDF rejection and repeat integrity hashing.
...
- Non-root application container, private infrastructure services and a loopback-bound local HTTP port. Sensitive actuator endpoints are blocked; Prometheus requires authentication.
